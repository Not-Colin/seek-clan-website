// app/api/admin/bingo/add-player/route.ts
...
export async function POST(request: Request) {
    ...
    try {
        ...
        // 2. Use the admin client to perform the insert, bypassing RLS
        ...
        console.error('Error adding player to bingo team:', error);
