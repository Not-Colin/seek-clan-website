...
import { useState, useEffect, ChangeEvent, FormEvent, Suspense } from 'react'; // <-- ADD Suspense HERE
...
export default function SubmitPage() {
  ...
  useEffect(() => {
    ...
    initializePage();
  }, [searchParams]); // searchParams is a dependency for this useEffect
  ...
  return (
    // --- WRAP THE ENTIRE COMPONENT'S JSX IN SUSPENSE ---
    <Suspense fallback={
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center text-white text-lg">
